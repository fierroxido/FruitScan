...
# ── Colores por tema ───────────────────────────────────────────────────────────
if tema == "dark":
    BG=="#080c12"; BG="#080c12"; SURFACE="#111826"; BORDER="#1e2d42"
    TEXT="#e8f0f8"; TEXT2="#94a8bc"; MUTED="#4a6070"
    ACCENT="#38bdf8"; ACCENT2="#818cf8"; FRESH="#34d399"; ROTTEN="#fb7185"
    BTNTEXT="#080c12"; GRAD1="rgba(56,189,248,.06)"; GRAD2="rgba(129,140,248,.06)"
else:
    ...
    BTNTEXT="#ffffff"; GRAD1="rgba(2,132,199,.05)"; GRAD2="rgba(99,102,241,.05)"
